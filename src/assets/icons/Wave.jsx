...
export default function Wave({ size }) {
  return (
    <div
      className={size === undefined ? styles.wave : undefined}
      role="presentation"
      style={size !== undefined ? { width: size, height: 10 } : undefined}
    >
      <svg viewBox="0 0 122 10" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 10, display: 'block' }}>
        <path
          opacity="0.4"
